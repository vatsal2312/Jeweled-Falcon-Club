...
contract JeweledFalconClub is ERC721A, Ownable {
  ...
  uint256 public constant JFC_PREORDER = 112; // may change
  ...
  function presaleBuy(uint256 quantity, bytes32[] calldata proof) external payable {
    ...
    require(MerkleProof.verify(proof, root, leaf), "Caller is not eligible for presale");
   ...
   * @param proof bytes32[] Merkle proof of wallet address
   * @return bool Presale eligibility of given address
   */
